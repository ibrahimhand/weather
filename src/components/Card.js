  ...
  return (
    <div className="mt-5">
      {showData === true ? (
              ...
              <div className="col-md-8">
                <div className="card-body text-start mt-2">
                  <h5 className="card-text">
                    <FaTemperatureHigh /> Maximale Temperature :{" "}
                    {(weather.main.temp_max - 273.15).toFixed(1)}ºC
                  </h5>
                  <h5 className="card-text">
                    <FaTemperatureLow /> Minimum Temperature :{" "}
                  ...
                  <h5 className="card-text">
                    <BsWind /> Wind speed : {weather.wind.speed}km/s
                  </h5>
                </div>
                <hr />
        ...
        <h2 className="text-dark ">No Results</h2>
      )}
    </div>
  );
};
